...
def extraer_detalles_concretos_pf(url):
    ...
    gmaps_url = rpf_html.find('a', {'id': 'ctl00_ContenedorContenidoSeccion_linkGoogle'}).attrs['href']
...
def pedir_html_puntos(url: str) -> str:
    ...
    r1 = SESSION.get(url)
    r1_html = BeautifulSoup(r1.content, features="lxml")
...
def extraer_puntos_moviles():
    ...
    return pd.read_html(html_txt)[0]
